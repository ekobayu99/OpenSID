...
<head>
	<title>Print Surat Keterangan Kehilangan</title>
...
<body>
	...
	<table>
		<tr>
			<td>Tersebut diatas telah datang kepada kami dan mengaku kehilangan berupa <?= $log_surat_detil['barang'] ?>.
				Dengan rincian <?= $log_surat_detil['rincian'] ?>.</td>
		</tr>
	</table>
