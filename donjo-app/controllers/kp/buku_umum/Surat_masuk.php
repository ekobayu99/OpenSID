...
class Surat_masuk extends Admin_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('kp/kp_surat_masuk_model');
    ...
    public function index($p = 1, $o = 2)
    {
        ...
        $data['subtitle']         = 'Buku Agenda - Surat Masuk KP';
    ...
    public function form($p = 1, $o = 0, $id = '')
    {
        ...
        $data['ref_disposisi'] = $this->kp_surat_masuk_model->get_pengolah_disposisi();
        ...
        $this->render('kp/surat_masuk/form', $data);
    }
    ...
    public function disposisi($id)
    {
        ...
        $this->load->view('kp/surat_masuk/disposisi', $data);
    }
