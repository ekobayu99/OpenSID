...
class Kp_permohonan_surat_admin extends Admin_Controller {
	...
	public function index($p = 1, $o = 0)
	{
		...
		$this->render('kp/mandiri/permohonan_surat', $data);
	}
	...
	public function periksa($id = '')
	{
		...
		$data['form_surat'] = "kp/surat/form_surat.php";
		$data['is_dari_permohonan'] = 1;
		$data['id_permohonan'] = $id;

		$this->render('kp/mandiri/periksa_surat', $data);
	}
