...
<body class="hold-transition skin-blue fixed layout-top-nav">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
						<ul class="nav navbar-nav">
							<li><a href="<?= site_url('layanan-mandiri-kp/profil'); ?>">Profil</a></li>
							<li><a href="<?= site_url('layanan-mandiri-kp/permohonan-surat'); ?>">Surat</a></li>
							<li><a href="<?= site_url('layanan-mandiri-kp/pesan-masuk'); ?>">Pesan</a></li>
							<li><a href="<?= site_url('layanan-mandiri-kp/bantuan'); ?>">Bantuan</a></li>
						</ul>
					</div>
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li>
								<a href="<?= site_url('layanan-mandiri-kp/permohonan-surat'); ?>" title="Permohonan Surat">
							...
							<li>
								<a href="<?= site_url('layanan-mandiri-kp/pesan-masuk'); ?>" title="Pesan Masuk">
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?= site_url('layanan-mandiri-kp/profil'); ?>" class="btn btn-default">Profil</a>
										</div>
			...
			<div class="container">
				<section class="content-header fixed">
					<div class="row hidden-xs">
						<a href="<?= site_url('layanan-mandiri-kp/profil'); ?>">
						...
						<a href="<?= site_url('layanan-mandiri-kp/permohonan-surat'); ?>">
							<div class="col-md-3 col-sm-6 col-xs-12">
						...
						<a href="<?= site_url('layanan-mandiri-kp/pesan-masuk'); ?>">
							<div class="col-md-3 col-sm-6 col-xs-12">
						...
						<a href="<?= site_url('layanan-mandiri-kp/bantuan'); ?>">
							<div class="col-md-3 col-sm-6 col-xs-12">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="box box-solid">
								...
								<div class="box-body">
									<a href="<?= ($this->is_login->ganti_pin === '1') ? '#' : site_url('layanan-mandiri-kp/cetak-biodata'); ?>" class="btn btn-block btn-social bg-green" target="_blank" rel="noopener noreferrer">
										<i class="fa fa-print"></i> Cetak Biodata
									</a>
									<?php if ($this->is_login->id_kk != 0): ?>
										<a href="<?= ($this->is_login->ganti_pin === '1') ? '#' : site_url('layanan-mandiri-kp/cetak-kk'); ?>" class="btn btn-block btn-social bg-aqua" target="_blank" rel="noopener noreferrer">
											<i class="fa fa-print"></i> Cetak Salinan KK
										</a>
									<?php endif; ?>
									<a href="<?= site_url('layanan-mandiri-kp/ganti-pin'); ?>" class="btn btn-block btn-social bg-navy">
						...
						<div class="col-md-9">
							<?php
								$this->load->view("kp/layanan_mandiri/$konten");
								...
								if ($this->is_login->ganti_pin === '1' && $this->uri->segment(2) != "ganti-pin"):
									...
									$data = [
										...
										'aksi' => site_url('layanan-mandiri-kp/ganti-pin')
									];

									$this->load->view('kp/layanan_mandiri/notif', $data);
								endif;
				...
				<?php $this->load->view('kp/layanan_mandiri/pendapat'); ?>
			</div>
		</div>
	...
	<script src="<?= base_url() ?>assets/front/js/mandiri.kp.js?v=<?=time();?>"></script>
