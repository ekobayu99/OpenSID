													...
													<table class="table table-bordered dataTable table-striped table-hover">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<?php if ($o == 2) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/1") ?>">No Urut <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o == 1) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/2") ?>">No Urut <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/1") ?>">No Urut <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
																<th>Jenis Surat</th>
																<?php if ($o == 4) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/3") ?>">Nama Penduduk <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o == 3) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/4") ?>">Nama Penduduk <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/3") ?>">Nama Penduduk <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
																<th nowrap>Keterangan</th>
																<th nowrap>Ditandatangani Oleh</th>
																<?php if ($o == 6) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/5") ?>">Tanggal <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o == 5) : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/6") ?>">Tanggal <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else : ?>
																	<th nowrap><a href="<?= site_url("kp_keluar/index/$p/5") ?>">Tanggal <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
																<th>User</th>
															</tr>
														</thead>
																...
																<tr>
																	...
																	<td nowrap>
																		...
																		<?php if (intval($data['is_ajukan']) == 0) : ?>
																			...
																			<?php endif; ?>
																			<a href="<?= site_url("kp_keluar/ajukan_ke_penandatangan/$data[id]") ?>" class="btn btn-danger btn-flat btn-sm" title="Ajukan ke Penandatangan"><i class="fa fa-send"></i></a>
																		<?php endif; ?>
																	</td>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="dataTables_length">
												<form id="paging" action="<?= site_url("kp_keluar") ?>" method="post" class="form-horizontal">
													<label>
														Tampilkan
											...
											<div class="dataTables_paginate paging_simple_numbers">
												<ul class="pagination">
													<?php if ($paging->start_link) : ?>
														<li><a href="<?= site_url("kp_keluar/index/$paging->start_link/$o") ?>" aria-label="First"><span aria-hidden="true">Awal</span></a></li>
													<?php endif; ?>
													<?php if ($paging->prev) : ?>
														<li><a href="<?= site_url("kp_keluar/index/$paging->prev/$o") ?>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
													<?php endif; ?>
													<?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
														<li <?= jecho($p, $i, "class='active'") ?>><a href="<?= site_url("kp_keluar/index/$i/$o") ?>"><?= $i ?></a></li>
													<?php endfor; ?>
													<?php if ($paging->next) : ?>
														<li><a href="<?= site_url("kp_keluar/index/$paging->next/$o") ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
													<?php endif; ?>
													<?php if ($paging->end_link) : ?>
														<li><a href="<?= site_url("kp_keluar/index/$paging->end_link/$o") ?>" aria-label="Last"><span aria-hidden="true">Akhir</span></a></li>
													<?php endif; ?>
												</ul>
											</div>
										</div>
